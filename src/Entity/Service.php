...
class Service implements EntityInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'service', targetEntity: PersonnelService::class,  cascade: ['remove'])]
    ...
    #[ORM\OneToMany(mappedBy: 'service', targetEntity: PersonnelGarde::class, cascade: ['remove'])]
